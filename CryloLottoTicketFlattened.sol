...
// File @openzeppelin/contracts/token/ERC721/extensions/IERC721Enumerable.sol@v5.4.0
...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol@v5.4.0
...
// File contracts/CryloLottoTicket.sol
...
contract CryloLottoTicket is ERC721Enumerable, Ownable {
    ...
    // Mint a ticket (requires CRYLO token payment)
    function mint() public {
        ...
        // Transfer CRYLO from user to contract
        bool success = cryloToken.transferFrom(msg.sender, address(this), ticketPriceUSD);
