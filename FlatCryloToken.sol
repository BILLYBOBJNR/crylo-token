...
contract CryloToken is ERC20, Ownable {
    ...
    // Tax: 4.5% (450 basis points)
    uint256 public constant TAX_BP = 450;
    uint256 public constant TAX_DENOM = 10_000;
    uint256 public constant PRIZE_BP = 200; // 2%
    uint256 public constant DEV_BP = 150;   // 1.5%
    uint256 public constant LP_BP = 100;    // 1%

    // Wallets
    address public immutable PRIZE_POOL;
        ...
        Ownable(msg.sender)
    {
        ...
        // Exempt key wallets and owner
        isTaxExempt[msg.sender] = true;
        isTaxExempt[PRIZE_POOL] = true;
        isTaxExempt[DEV_WALLET] = true;
        isTaxExempt[LP_WALLET] = true;
        isTaxExempt[address(this)] = true;
    }

    // Add your other token logic (taxes, swap, etc.) below this point
}
